...
const getPool = () => {
  if (!pool) {
    // Try to parse MySQL URL if provided (prefer PUBLIC_URL for external access)
    ...
    // If MYSQL_PUBLIC_URL is provided, parse it
    if (mysqlUrl) {
      try {
        ...
        console.error('Failed to parse MYSQL_URL:', e);
      }
    }
